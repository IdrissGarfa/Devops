                    ...
                    (
                        <>
                                    ...
                                    <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                                        <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                                            ...
                                            <form className="space-y-4 md:space-y-6" onSubmit={formik.handleSubmit}>
                                                <div>
                                                    <label for="email" className={`${formik.touched.email && formik.errors.email ? "text-orange-500" : "text-gray-900"} block mb-2 text-sm font-medium dark:text-white`}>
                                                        {
                                                ...
                                                <div>
                                                    <label for="password" className={`${formik.touched.password && formik.errors.password ? "text-orange-500" : "text-gray-900"} block mb-2 text-sm font-medium dark:text-white`}>
                                                        {
                            ...
                            <section className='hidden md:flex flex-1 items-center justify-center'>
                                <img className='h-[80%] mr-14' src={devopsBg} alt="img" />
                            </section>
                        </>
                    )
            }
