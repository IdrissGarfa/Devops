...
const Footer = () => {
  return (
      <div className="w-full">
          <div className="w-[90%] py-20 mx-auto grid gap-10 lg:gap-0 lg:justify-items-center grid-cols-1 lg:grid-cols-4 md:grid-cols-2 ">
              ...
              <div className="md:order-3 lg:order-2">
                  ...
                  <ul className="flex flex-col gap-6">
                    <li><Link className="text-white text-lg md:text-xl">Our Story</Link></li>
                    <li><Link className="text-white text-lg md:text-xl">Events</Link></li>
                    <li><Link className="text-white text-lg md:text-xl">DevOps</Link></li>
                    <li><Link className="text-white text-lg md:text-xl">Blog</Link></li>
                  </ul>
              </div>
              <div className="md:order-4 lg:order-3">
                  <h2 className="text-[#686b7a] font-semibold text-2xl mb-6">Ressources</h2>
                  <ul className="flex flex-col gap-6">
                    <li><Link className="text-white text-lg md:text-xl">Apps</Link></li>
                    <li><Link className="text-white text-lg md:text-xl">Developer</Link></li>
                    <li><Link className="text-white text-lg md:text-xl">Integration</Link></li>
                    <li><Link className="text-white text-lg md:text-xl">Community</Link></li>
                  </ul>
              </div>
                  ...
                  <ul className="flex flex-col gap-6">
                    <li>
                      <Link className="text-white text-xl flex items-center gap-4">
                        <MdOutlineEmail className="text-gray-300 text-lg md:text-xl"/>
                        devopsisima@gmail.com
                      </Link>
                    </li>
                    <li>
                      <Link className="text-white text-xl flex items-center gap-4">
                        <FiPhoneCall  className="text-gray-300 text-lg md:text-xl" />
                        54 902 901
                      </Link>
                    </li>
